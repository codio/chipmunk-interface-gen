...
const file_proto_vnc_vnc_service_proto_rawDesc = "" +
	"\n" +
	"\x1bproto/vnc/vnc_service.proto\x12\x1ccom.codio.chipmunk.proto.vnc\"\x12\n" +
	"\x10GetStatusRequest\"\x86\x01\n" +
	"\x11GetStatusResponse\x12N\n" +
	"\x06status\x18\x01 \x01(\x0e26.com.codio.chipmunk.proto.vnc.GetStatusResponse.StatusR\x06status\"!\n" +
	"\x06Status\x12\n" +
	"\n" +
	"\x06UNKOWN\x10\x00\x12\v\n" +
	"\aRUNNING\x10\x01\"\x1a\n" +
	"\x18RestartVncServiceRequest\"\x1b\n" +
	"\x19RestartVncServiceResponse2\xfa\x01\n" +
	"\x03Vnc\x12l\n" +
	"\tGetStatus\x12..com.codio.chipmunk.proto.vnc.GetStatusRequest\x1a/.com.codio.chipmunk.proto.vnc.GetStatusResponse\x12\x84\x01\n" +
	"\x11RestartVncService\x126.com.codio.chipmunk.proto.vnc.RestartVncServiceRequest\x1a7.com.codio.chipmunk.proto.vnc.RestartVncServiceResponseB3Z1github.com/codio/chipmunk-interface-gen/proto/vncb\x06proto3"

var (
	file_proto_vnc_vnc_service_proto_rawDescOnce sync.Once
	file_proto_vnc_vnc_service_proto_rawDescData []byte
)

func file_proto_vnc_vnc_service_proto_rawDescGZIP() []byte {
	file_proto_vnc_vnc_service_proto_rawDescOnce.Do(func() {
		file_proto_vnc_vnc_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_vnc_vnc_service_proto_rawDesc), len(file_proto_vnc_vnc_service_proto_rawDesc)))
	})
...
var file_proto_vnc_vnc_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_proto_vnc_vnc_service_proto_depIdxs = []int32{
	...
	2, // 3: com.codio.chipmunk.proto.vnc.Vnc.GetStatus:output_type -> com.codio.chipmunk.proto.vnc.GetStatusResponse
	4, // 4: com.codio.chipmunk.proto.vnc.Vnc.RestartVncService:output_type -> com.codio.chipmunk.proto.vnc.RestartVncServiceResponse
...
func file_proto_vnc_vnc_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_vnc_vnc_service_proto_rawDesc), len(file_proto_vnc_vnc_service_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
